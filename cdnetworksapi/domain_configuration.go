...
type CompressionSetting struct {
	...
	FileTypeOthers     *[]string `json:"file-type-others,omitempty" xml:"file-type-others>file-type-other,omitempty"`
	CustomFileTypes    *[]string `json:"custom-file-types,omitempty" xml:"custom-file-types>custom-file-type,omitempty"`
	UriFileTypes       *[]string `json:"uri-file-types,omitempty" xml:"uri-file-types>uri-file-type,omitempty"`
}
...
type TimestampVisitControlRule struct {
	...
	LowerLimitExpiryTime     *int64  `json:"lower-limit-expiry-time,omitempty" xml:"lower-limit-expiry-time,omitempty"`
	UpperLimitExpiryTime     *int64  `json:"upper-limit-expiry-time,omitempty" xml:"upper-limit-expiry-time,omitempty"`
